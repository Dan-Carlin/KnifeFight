/*
KFInstructionsModal - Modal that activates when a game is started.
*/
...
// Layouts
import KFInstructionsModalLandscapeLayout from "./layouts/KFInstructionsModalLandscapeLayout";
import KFInstructionsModalPortraitLayout from "./layouts/KFInstructionsModalPortraitLayout";
  ...
  return (
    <>
      {orientation.isPortrait && (
        <KFInstructionsModalPortraitLayout actions={actions} values={values} />
      )}
      {orientation.isLandscape && (
        <KFInstructionsModalLandscapeLayout actions={actions} values={values} />
      )}
    </>
  );
}
