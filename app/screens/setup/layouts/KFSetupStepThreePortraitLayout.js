/*
KFSetupStepThreePortraitLayout - Portrait layout for the third setup screen.
*/
...
function KFSetupStepThreePortraitLayout({ actions, values }) {
  return (
    <Screen style={defaultStyles.screenContainer} isPortrait={true}>
      <View style={styles.bodyContainer}>
        ...
        <View style={[styles.traitGrid, portraitStyles.traitGrid]}>
          <View style={styles.traitRow}>
            <View style={[styles.traitButton, portraitStyles.traitButton]}>
              <TraitButton
...
export default KFSetupStepThreePortraitLayout;
